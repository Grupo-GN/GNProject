...
{
    [Serializable]
    public class Documento_CaracteristicaBE
    {
        public Int32 id_documento_caracteristica { get; set; }
        public Int32 id_documento { get; set; }
        public String no_caracteristica { get; set; }
        public String co_tipo_dato { get; set; }
        public String no_valor_dato { get; set; }
    ...
    [Serializable]
    public class Documento_CaracteristicaBEList : List<Documento_CaracteristicaBE>
    {
        public void Ordenar(string propertyName, direccionOrden Direction)
        {
            Documento_CaracteristicaBEComparer dc = new Documento_CaracteristicaBEComparer(propertyName, Direction);
            this.Sort(dc);
        }
    }

    class Documento_CaracteristicaBEComparer : IComparer<Documento_CaracteristicaBE>
    {
        string _prop = "";
        direccionOrden _dir;

        public Documento_CaracteristicaBEComparer(string propertyName, direccionOrden Direction)
        {
            _prop = propertyName;
            _dir = Direction;
        }

        public int Compare(Documento_CaracteristicaBE x, Documento_CaracteristicaBE y)
        {
