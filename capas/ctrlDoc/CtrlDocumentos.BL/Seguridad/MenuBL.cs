...
namespace CtrlDocumentos.BL.Seguridad
{
    public class MenuBL
    {
        ...
        public TreeViewBEList Get_ArbolPlantillasDoc(string ruc)
        {
            try
            {
                List<ArbolBE> oLista_Arbol = new List<ArbolBE>();
                ComboBL oComboBL = new ComboBL();
                ComboBEList oGrupos = oComboBL.Get_Combo("CDOC_00006", ruc);

                Maestros.ParametroBL oParametroBL = new Maestros.ParametroBL();
                ...
                Maestros.PlantillaDocBL oPlantillaDocBL = new Maestros.PlantillaDocBL();
