<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JustificacionJefes.aspx.cs" Inherits="GNProject.Views.ControlAsisten.CA.Justificacion.JustificacionJefes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="tableDialog">
        ...
        <tr>
            <td style="text-align:right;"><label class="miLabel">Jefe : </label></td>
            <td><label class="miLabel" id="lblJefe"></label></td>
            <td style="text-align:right;"><label class="miLabel">Periodo : </label></td>
            <td><label class="miLabel" id="lblPeriodo"></label></td>
        </tr>
    </table>
    <hr />
    <section id="TabContainerMarc" style="min-height:400px;">
        <ul>
            ...
            <li><a href="#Tab4">Permisos/Justificaciones</a></li>
        </ul>
        <section id="Tab1">
            <fieldset>
...
<br />
    ...
    <script src="Scripts/Script_JustificacionJefes.js?v1.3" type="text/javascript"></script>
    ...
    <script type="text/javascript" async>
        ...
        $(document).ready(function () {
            ...
            Get_Localidad_List();
            Get_Categoria_List();
            Get_DatosPersonal(Jefe_Proc);
            Get_Personal_List(Get_Planilla_Find(), Periodo_Des, Get_Localidad_Find(), Get_Categoria_Find(), Jefe_Proc);
            Get_Justificaciones_Pendientes_Jefe(Personal_Fin, FechaIniPer, FechaFinPer, Jefe_Proc);
            Get_Permisos_Pendientes_Personal(Personal_Fin, FechaIniPer, FechaFinPer, Jefe_Proc);
            Get_Permisos_Horas_Pendientes_Personal(Personal_Fin, FechaIniPer, FechaFinPer, Jefe_Proc);
            CrearFechas();
            CargarHorasMin();
            Get_Tipo_Permisos();
            ...
            $('#btnAAJustIng').click(function () {
                if ($(this).attr('name')) {
                    if (confirm('¿Esta seguro de continuar?')) {
                        ...
                        Get_AA_Justificacion($(this).attr('name'), newhoraIng, Jefe_Proc);
                    }
                } else {
            ...
            $('#btnAAJustSal').click(function () {
                if ($(this).attr('name')) {
                    if (confirm('¿Esta seguro de continuar?')) {
                        ...
                        Get_AA_Justificacion($(this).attr('name'), newhoraSal, Jefe_Proc);
                    }
                } else {
                    alert('.::Error > Justificacion no definida.');
                }
            ...
            $('#btnAproIng').click(function () {
                if ($(this).attr('name')) {
                    if (confirm('¿Esta seguro de Aprobar?')) {
                        Get_AprobarDesaprobar_Justificacion($(this).attr('name'), '03', Jefe_Proc);
                    }
                } else {
                    alert('.::Error > Justificacion no definida.');
                }
            ...
            $('#btnDesaproIng').click(function () {
                if ($(this).attr('name')) {
                    if (confirm('¿Esta seguro de Desaprobar?')) {
                        Get_AprobarDesaprobar_Justificacion($(this).attr('name'), '04', Jefe_Proc);
                    }
                } else {
                    alert('.::Error > Justificacion no definida.');
                }
            ...
            $('#btnGAPermisoFecha').click(function () {
                if (confirm('¿Esta seguro de continuar?')) {
                    ...
                    var comentario = $('#txtComentJefe').val();
                    ...
                    Get_AA_Permiso_Fechas(PermisoD_Proc, Permiso_Id, formatFecha.ymd(FechaIni), formatFecha.ymd(FechaFin), Descuento, NroDoc, comentario.toUpperCase(), Jefe_Proc);
                }
            });
            ...
            $('#btnAproPFecha').click(function () {
                if (confirm('¿Esta seguro de aprobar?')) {
                    var comentario = $('#txtComentJefe').val();
                    Get_AprobarDesaprobar_Permiso_Fechas(PermisoD_Proc, comentario.toUpperCase(), '03', Jefe_Proc);
                }
            });
            $('#btnDesaproPFecha').click(function () {
                if (confirm('¿Esta seguro de desaprobar?')) {
                    var comentario = $('#txtComentJefe').val();
                    Get_AprobarDesaprobar_Permiso_Fechas(PermisoD_Proc, comentario.toUpperCase(), '04', Jefe_Proc);
                }
            });
            ...
            $('#btnAAPerHoras').click(function () {
                if (confirm('¿Esta seguro de continuar?')) {
                    ...
                    var comentario = $('#txtComentJefeH').val();
                    ...
                    Get_AA_Permisos_Horas(PermisoH_Proc, Permiso_Id, formatFecha.ymd(Fecha), fechaHINI, fechaHFIN, Descuento, comentario.toUpperCase(), Jefe_Proc, AplicarA);
                }
            });
            ...
            $('#btnAproPHora').click(function () {
                if (confirm('¿Esta seguro de aprobar?')) {
                    var comentario = $('#txtComentJefeH').val();
                    Get_AprobarDesaprobar_Permiso_Horas(PermisoH_Proc, comentario.toUpperCase(), '03', Jefe_Proc);
                }
            });
            $('#btnDesaPHora').click(function () {
                if (confirm('¿Esta seguro de desaprobar?')) {
                    var comentario = $('#txtComentJefeH').val();
                    Get_AprobarDesaprobar_Permiso_Horas(PermisoH_Proc, comentario.toUpperCase(), '04', Jefe_Proc);
                }
            });
            ...
            $('#btnGrabarJust').click(function () {
                ...
                if (tipo == '01') {
                    ...
                    var newhoraIng = hi + ':' + mi;
                    Get_AM_Justificacion_Otros(FechaProc, tipo, Get_Personal_Find(), newhoraIng, '02', motivo.toUpperCase(), '02', Jefe_Proc, '03');
                    ...
                    var newhoraSal = hs + ':' + ms;
                    Get_AM_Justificacion_Otros(FechaProc, tipo, Get_Personal_Find(), newhoraSal, '02', motivo.toUpperCase(), '02', Jefe_Proc, '03');
                }
            ...
            $('#btnGrabarPermiso').click(function () {
                ...
                var ComentJefe = $('#txtComentJefeJEF').val();
                ...
                , formatFecha.ymd(FechaFin), Descuento, TipoReg, Motivo.toUpperCase(), NroDoc, '01', ComentJefe, '00', '', '02', Jefe_Proc, '03');
            ...
            $('#tbodyPermisosJEF').on('click', '.buttonDesactiva', function () {
                if (confirm('¿Esta seguro de cancelar la solicitud ?')) {
                    Get_Cancelar_SolicitudPermisoDias(this.id, Jefe_Proc);
                }
            });
            ...
            $('#btnGrabarPH').click(function () {
                ...
                var ComenteJefe = $('#txtComentJefeHJEF').val();
                ...
                , Descuento, TipoReg, '01', ComenteJefe, '00', '', Motivo.toUpperCase(), Jefe_Proc, '02', '03', AplicarA);
            });
            ...
            $('#tbodyPermisoHoraJEF').on('click', '.buttonDesactiva', function () {
                if (confirm('¿Esta seguro de cancelar la solicitud ?')) {
                    Get_Cancelar_SolicitudPermisoHoras(this.id, Jefe_Proc);
                }
            });
            ...
            $('#btnAproAllJust').click(function () {
                ...
                if (confirm('¿Está seguro de aprobar lo seleccionado?')) {
                    Proc_AprobarJustificacion(Asistencia, Jefe_Proc);
                }
            });
        });
    </script>
