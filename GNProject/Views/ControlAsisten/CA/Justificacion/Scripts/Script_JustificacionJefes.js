...
function Get_Personal_List(Planilla_Id, Periodo, Localidad_Id, Categoria_Id, Jefe_Id) {
    var params = {
...
function Get_Justificaciones_Pendientes_Jefe(Personal_Id, FechaIni, FechaFin, Jefe_Id) {
    var params = {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_Justificaciones_Pendientes_Jefe",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Data = response.d;
            var lengthD = Data.length - 1;
...
function Get_AA_Justificacion(Justificacion_Id, NewHora, PersoModif) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_AA_Justificacion",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
...
function Get_AprobarDesaprobar_Justificacion(Justificacion_Id, Estado, PersoModif) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_AprobarDesaprobar_Justificacion",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Proceso = response.d;
            if (Proceso) {
...
function Proc_AprobarJustificacion(Asistencia_Id, PersoModif) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Proc_AprobarJustificacion",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Proceso = response.d;
            if (Proceso) {
...
function Get_Permisos_Pendientes_Personal(Personal_Id, FechaIni, FechaFin, Jefe_Id) {
    var params = {
        Personal_Id: Personal_Id,
        FechaIni: FechaIni,
        FechaFin: FechaFin,
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_Permisos_Pendientes_Personal",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Data = response.d;
            var lengthD = Data.length - 1;
...
function Get_AprobarDesaprobar_Permiso_Fechas(PermisoD_Id, Comentarios, Estado, PersoModif) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_AprobarDesaprobar_Permiso_Fechas",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Proceso = response.d;
            if (Proceso) {
...
function Get_AA_Permiso_Fechas(PermisoD_Id, TPermiso_Id, FechaIni, FechaFin, Descuento, NroDoc, Comentarios, PersoModif) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_AA_Permiso_Fechas",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Proceso = response.d;
            if (Proceso) {
...
function Get_Permisos_Horas_Pendientes_Personal(Personal_Id, FechaIni, FechaFin, Jefe_Id) {
    var params = {
        Personal_Id: Personal_Id,
        FechaIni: FechaIni,
        FechaFin: FechaFin,
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_Permisos_Horas_Pendientes_Personal",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Data = response.d;
            var lengthD = Data.length - 1;
...
function Get_AprobarDesaprobar_Permiso_Horas(PermisoH_Id, Comentarios, Estado, PersoModif) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_AprobarDesaprobar_Permiso_Horas",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Proceso = response.d;
            if (Proceso) {
...
function Get_AA_Permisos_Horas(PermisoH_Id, TPermiso_Id, Fecha, HoraIni, HoraFin, Descuento, Comentario, PersoModif, AplicarIngSal) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "JustificacionJefes.aspx/Get_AA_Permisos_Horas",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Proceso = response.d;
            if (Proceso) {
...
function Get_DatosPersonal(Personal_Id) {
