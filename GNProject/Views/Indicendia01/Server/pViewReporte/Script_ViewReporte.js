function Get_Find_ReporteIncidente(Incidente_Id) {
    ...
    $.ajax({
        ...
        dataType: "json",
        url: "sViewReporte.aspx/Get_Find_ReporteIncidente",
...
function Get_AccionCorrectiva_List(Incidente_Id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sViewReporte.aspx/Get_AccionCorrectiva_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
...
function Get_Files_Incidencia_List(Incidente_Id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sViewReporte.aspx/Get_Files_Incidencia_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthd = Datos.length - 1;
...
function Get_DataList_Responsable(Nombres, Usuario, Area_Id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sViewReporte.aspx/Get_DataList_Responsable",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_Find_AccionCorrectiva(Incidente_Id, Accion_Id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sViewReporte.aspx/Get_Find_AccionCorrectiva",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            if (Datos) {
...
function Get_Reg_CausaReporte_Detalle_List(Incidente_Id, Tipo) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sViewReporte.aspx/Get_Reg_CausaReporte_Detalle_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_Files_Accion_List(Incidente_Id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sViewReporte.aspx/Get_Files_Accion_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            datos = response.d;
        },
