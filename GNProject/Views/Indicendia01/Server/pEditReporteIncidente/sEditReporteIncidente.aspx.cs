...
namespace GNProject.Views.Indicendia01.Server.pEditReporteIncidente
{
    public partial class sEditReporteIncidente : System.Web.UI.Page
    {
        [WebMethod]
        ...
        {
            return controller_EditReporteIncidente.Get_Instance().Get_Update_AccionCorrectiva(Incidente_Id
                , Accion_Id, Descripcion, Tipo_Responsable
               , Responsable_Id, FechaIni, FechaFin);
        }

        [WebMethod]
        public static string Get_AprobarReporte(string Incidente_Id)
        {
            return controller_EditReporteIncidente.Get_Instance().Get_AprobarReporte(Incidente_Id);
        }
