<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="sCategoriaAuxiliar2.aspx.cs" Inherits="GNProject.Views.Indicendia01.Server.pCategoriaAuxiliar2.sCategoriaAuxiliar2" %>
...
<fieldset>
    ...
    <label>Categoria Auxiliar : </label><select id="cboCateAuxFind" class="cbo"></select>
...
<tbody id="tbodyCategoriaA">
 ...
 <div style="overflow: hidden; width: 100%; border: solid 1px #505050;">
    ...
    <div id="dialog-Categoria" title="MATENIMIENTO LOCALIDAD">
    <table class="tableDialog">
        ...
        <tr>
            ...
            <td><select id="cboCateAux" class="cbo"></select></td>
        </tr>
        <tr>
            <td style="text-align:right;font-weight:bold;vertical-align:text-top;">Seccion :</td>
...
<br /><br /><br /><br /><br />
    ...
    <script src="Script_CategoriaAuxliar2.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            Get_CategoriaAuxliar_Combo();
            Get_CategoriaAuxliar2_List(get_FindCateAux(), get_FindDescrip(), inicio);
            Get_CategoriaAuxliar2_List_MaxRows(get_FindCateAux(), get_FindDescrip());
            ...
            $('#btnGrabar').click(function () {
                ...
                if (TIPOPROCESO == '01') {
                    ...
                    if (!area) {
                        $('#lblError').html('.::Error, Ara no definida.');
                        $('#cboCateAux').focus();
                        return false;
                    }
                    Get_Update_CategoriaAuxliar2(Categoria_Proc, area, descripcion.toUpperCase());
                }
                Get_CategoriaAuxliar2_List(get_FindCateAux(), get_FindDescrip(), inicio);
                Get_CategoriaAuxliar2_List_MaxRows(get_FindCateAux(), get_FindDescrip());
            });

            $('#cboCateAuxFind').change(function () {
                inicio = 0;
                Get_CategoriaAuxliar2_List(get_FindCateAux(), get_FindDescrip(), inicio);
                Get_CategoriaAuxliar2_List_MaxRows(get_FindCateAux(), get_FindDescrip());
            });
            ...
            $('#tbodyCategoriaA').on('click', '.buttonEdit', function () {
                var codigo = this.id;
                Get_CategoriaAuxliar2_Find(codigo);
            });
