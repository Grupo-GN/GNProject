...
function Get_Intensidad_List() {
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_Intensidad_List",
...
function Get_Severidad_List() {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_Severidad_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_Tipo_List() {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_Tipo_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_Origen_List() {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_Origen_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_Categoria_Auxiliar_Combo() {
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_Categoria_Auxiliar_Combo",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_Categoria_Auxiliar2_Combo() {
    ...
    $.ajax({
        ...
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_Categoria_Auxiliar2_Combo",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_DataList_Responsable(Nombres, Usuario, Area_Id) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_DataList_Responsable",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_Localidad_Combo() {
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_Localidad_Combo",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_TipoIncidente_List() {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_TipoIncidente_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_AfectadoInc_List() {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_AfectadoInc_List",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
...
function Get_CausasTipo_Report(Tipo) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(params),
        dataType: "json",
        url: "sEditRepPlanta.aspx/Get_CausasTipo_Report",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
