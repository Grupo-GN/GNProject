/*function Get_Localidad_Combo() {
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "sListReportesPlanta.aspx/Get_Localidad_List",
...
function Get_Reportes_List_PLANT(Area_Id, Per_Registro, FechaIni, FechaFin) {
    var params = {
        Area_Id: Area_Id,
    ...
    $.ajax({
        ...
        dataType: "json",
        url: "sListReportesPlanta.aspx/Get_Reportes_List_PLANT",
        contentType: "application/json; chartseft:utf-8",
        success: function (response) {
            var Datos = response.d;
            var lengthD = Datos.length - 1;
            ...
            for (var i = 0; i <= lengthD; i++) {
                ...
                switch (estado) {
                    ...
                    case '02': estado = ''; btnEdit = ''; break;
                    case '03': estado = 'EN CURSO'; btnEdit = ''; break;
...
function get_FechaIniFind() {
    return formatFecha.ymd($('#txtFechaIni').val());
};

function get_FechaFinFind() {
    return formatFecha.ymd($('#txtFechaFin').val()) + ' 23:59';
};
