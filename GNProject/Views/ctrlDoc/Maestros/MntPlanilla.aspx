<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MntPlanilla.aspx.cs" Inherits="GNProject.Views.ctrlDoc.Maestros.MntPlanilla" %>

<%@ Import Namespace="GNProject.Acceso" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="pagina1">
        <div class="row linea-bottom">
            <div class="col l4 s12 titulo">Lista de Planillas</div>
        ...
        <div class="row">
            ...
            <div class="col l3 m4 s8">
                <input id="txtNomPlanilla_Bus" type="text" class="control-form" />
            </div>
            <div class="col l1 m2 s4">
                <label>Estado</label>
            </div>
    ...
    <div id="pagina2" style="display: none;">
        ...
        <div class="row">
            ...
            <div class="col l3 m4 s8">
                <input id="txtNomPlanilla" type="text" class="control-form" />
            </div>
            <div class="col l1 m2 s4">
                <label>Detalle</label>
            </div>
    ...
    <script type="text/javascript">
        ...
        var strCabecera_Bandeja = ['ID', 'Planilla', 'Detalle', '', 'CodEstado', 'Estado'];
        var ModelCol_Bandeja = [
                            { name: 'id_planilla', index: 'id_planilla', width: 40, sorttype: 'number', sortable: true, align: 'center', hidden: true },
                            { name: 'no_planilla', index: 'no_planilla', width: 200, sortable: true },
                            { name: 'de_planilla', index: 'de_planilla', hidden: true },
        ...
        fn_Iniciar();
        function fn_Iniciar() {
            $('#txtNomPlanilla_Bus').keydown(function (event) {
        ...
        function fn_Editar(rowID) {
            ...
            /*Establece valores*/
            document.getElementById("txtID").value = rowData['id_planilla'];
            document.getElementById("txtNomPlanilla").value = rowData["no_planilla"];
            document.getElementById("txtDetalle").value = rowData["de_planilla"];
        ...
        function fn_Limpiar_Editar() {
            ...
            document.getElementById("txtNomPlanilla").value = "";
            ...
            document.getElementById("txtNomPlanilla").focus();
        }

        function fn_Guardar() {
            var msg_retorno = "";
            if ($("#txtNomPlanilla").val() == "") {
                msg_retorno += "- Debe ingresar un nombre de planilla.\n";
            }
            if ($("#cboEstado").val() == "") {
            ...
            if (msg_retorno != "") {
                ...
                var id_planilla = $("#txtID").val();
                var arr_parametros = new Array();
                arr_parametros[0] = id_planilla;
                arr_parametros[1] = $("#txtNomPlanilla").val();
