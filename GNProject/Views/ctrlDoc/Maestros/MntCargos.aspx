<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MntCargos.aspx.cs" Inherits="GNProject.Views.ctrlDoc.Maestros.MntCargos" %>

<%@ Import Namespace="GNProject.Acceso" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    <div id="pagina1">
        <div class="row linea-bottom">
            <div class="col l4 s12 titulo">Lista de Cargos</div>
        ...
        <div class="row">
            ...
            <div class="col l3 m4 s8">
                <input id="txtNomCargo_Bus" type="text" class="control-form" />
            </div>
            <div class="col l1 m2 s4">
                <label>Estado</label>
            </div>
    ...
    <div id="pagina2" style="display: none;">
        ...
        <div class="row">
            ...
            <div class="col l3 m4 s8">
                <input id="txtNomCargo" type="text" class="control-form" />
            </div>
            <div class="col l1 m2 s4">
                <label>Detalle</label>
            </div>
    ...
    <script type="text/javascript">
        ...
        var strCabecera_Bandeja = ['ID', 'Cargo', 'Detalle', '', 'CodEstado', 'Estado'];
        var ModelCol_Bandeja = [
                            { name: 'id_cargo', index: 'id_cargo', width: 40, sorttype: 'number', sortable: true, align: 'center', hidden: true },
                            { name: 'no_cargo', index: 'no_cargo', width: 200, sortable: true },
                            { name: 'de_cargo', index: 'de_cargo', hidden: true },
        ...
        fn_Iniciar();
        function fn_Iniciar() {
            $('#txtNomCargo_Bus').keydown(function (event) {
        ...
        function fn_Buscar() {
            ...
            arr_parametros[0] = $("#txtNomCargo_Bus").val();
        ...
        function fn_Editar(rowID) {
            ...
            /*Establece valores*/
            document.getElementById("txtID").value = rowData['id_cargo'];
            document.getElementById("txtNomCargo").value = rowData["no_cargo"];
            document.getElementById("txtDetalle").value = rowData["de_cargo"];
        ...
        function fn_Limpiar_Editar() {
            ...
            document.getElementById("txtNomCargo").value = "";
            ...
            document.getElementById("txtNomCargo").focus();
        }

        function fn_Guardar() {
            var msg_retorno = "";
            if ($("#txtNomCargo").val() == "") {
                msg_retorno += "- Debe ingresar un nombre de cargo.\n";
            }
            if ($("#cboEstado").val() == "") {
            ...
            if (msg_retorno != "") {
                ...
                var id_cargo = $("#txtID").val();
                var arr_parametros = new Array();
                arr_parametros[0] = id_cargo;
                arr_parametros[1] = $("#txtNomCargo").val();
