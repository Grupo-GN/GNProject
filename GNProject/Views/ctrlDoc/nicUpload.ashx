...
public class nicUpload : IHttpHandler 
{
    ...
    private String fileServerPath = ConfigurationManager.AppSettings["FileServerPath"] + "Documentos\\ImgUpload\\";
    ...
    private class FileStatus
    {
        ...
        public void SetValues(string fileName, int fileLength, int ancho, int alto, string msg_error)
        {
            ...
            {
                //String virtualServerPathPublic = ConfigurationManager.AppSettings["VirtualPathPublic"] + "Documentos/ImgUpload/";
                String virtualServerPathPublic = ConfigurationManager.AppSettings["RutaServidor"] + "Documentos/ImgUpload/";
