<%@ Page Async="true"Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MantFormatos.aspx.cs" Inherits="GNProject.Views.portal.Mantenimientos.MantFormatos" UnobtrusiveValidationMode="None"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblNormativaId" runat="server" Text="" Font-Bold="True" ForeColor="#006699"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
    ...
    <script type="text/javascript">
        var no_pagina = "MantFormatos.aspx";
        /*[INICIO] - Variables Grilla Bandeja*/
        var idGrilla_Bandeja = "#grvBandeja";
        var idPieGrilla_Bandeja = "#grvBandeja_Pie";
        var strCabecera_Bandeja = ['', 'ID Formato', 'Titulo', '<%=GNProject.Acceso.App_code_portal.Parametros.I_Texto_CategoriaAuxiliar%>', 'Usuario', 'Fecha'];
        var ModelCol_Bandeja = [
                            { name: 'Accion', width: 50, align: 'center' },
                            { name: 'Normativa_Id', index: 'Normativa_Id', width: 60, align: 'center' },
