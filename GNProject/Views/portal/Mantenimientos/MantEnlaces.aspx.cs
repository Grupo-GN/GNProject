    ...
    public partial class MantEnlaces : System.Web.UI.Page
    {
            ...
            , int pPageSize, int pCurrentPage, string pSortColumn, string pSortOrder)
        {
            ...
            foreach (Enlace obj in sortedRecords)
            {
                ...
                object filas = new
                {
                    Accion = "<img title='Editar' src='/Assets/images/imgPortal/img_buttons/icono_editar.png' width='15px' onclick='fn_Editar(&#39;" + obj.Enlace_Id + "&#39;)'> <img title='Eliminar' src='/Assets/images/imgPortal/img_buttons/icono_cerrar.png' width='15px' onclick='fn_Eliminar(&#39;" + obj.Enlace_Id + "&#39;)'>",
