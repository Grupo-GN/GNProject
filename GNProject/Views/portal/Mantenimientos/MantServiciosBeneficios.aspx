<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MantServiciosBeneficios.aspx.cs" Inherits="GNProject.Views.portal.Mantenimientos.MantServiciosBeneficios"UnobtrusiveValidationMode="None" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="title">
        Mantenimiento de Beneficios</div>
    <br />
    <div id="Tab1">
        <div>
            <table>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblBeneficioId" runat="server" Text="" Font-Bold="True" ForeColor="#006699"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                 <asp:Label ID="lblNomBeneficio" runat="server" Text=""></asp:Label>
    ...
    <script type="text/javascript">
        var no_pagina = "MantServiciosBeneficios.aspx";
        /*[INICIO] - Variables Grilla Bandeja*/
        var idGrilla_Bandeja = "#grvBandeja";
        var idPieGrilla_Bandeja = "#grvBandeja_Pie";
        var strCabecera_Bandeja = ['', 'ID Beneficio', 'Titulo', 'Usuario', 'Fecha'];
        var ModelCol_Bandeja = [
                            { name: 'Accion', width: 50, align: 'center' },
                            { name: 'Beneficio_Id', index: 'Beneficio_Id', width: 60, align: 'center' },
