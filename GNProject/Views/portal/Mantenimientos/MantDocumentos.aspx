<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MantDocumentos.aspx.cs" Inherits="GNProject.Views.portal.Mantenimientos.MantDocumentos" UnobtrusiveValidationMode="None" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="title">
        Mantenimiento de Documentos y Manuales</div>
    <br />
    <div id="Tab1">
        <div>
            <table>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblDocumentoId" runat="server" Text="" Font-Bold="True" ForeColor="#006699"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                 <asp:Label ID="lblNomDocumento" runat="server" Text=""></asp:Label>
    ...
    <script type="text/javascript">
        var no_pagina = "MantDocumentos.aspx";
        ...
        var ModelCol_Bandeja = [
                            ...
                            { name: 'Documento_Id', index: 'Documento_Id', width: 60, align: 'center' },
