    ...
    public partial class MantAnuncios : System.Web.UI.Page
    {
            ...
            , int pPageSize, int pCurrentPage, string pSortColumn, string pSortOrder)
        {
            ...
            foreach (Anuncios obj in sortedRecords)
            {
                ...
                object filas = new
                {
                    Accion = "<img title='Editar'src='/Assets/images/imgPortal/img_buttons/edit.png' class='icons-table editItem' width='15px' onclick='fn_Editar(&#39;" + obj.Anuncio_Id + "&#39;)'> <img title='Eliminar'src='/Assets/images/imgPortal/img_buttons/delete.png' class='icons-table deleteItem' width='15px' onclick='fn_Eliminar(&#39;" + obj.Anuncio_Id + "&#39;)'>",
