<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MantReservacionSalas.aspx.cs" Inherits="GNProject.Views.portal.Mantenimientos.MantReservacionSalas" UnobtrusiveValidationMode="None"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="title">
        Mantenimiento de Reservación de Salas</div>
    <br />
    <div id="Tab1">
        <div>
            <table>
                <tr>
                    <td>
                        ...
                        <asp:Button ID="btnNuevo" class="EstiloGeneralBoton btn-nuevo" runat="server" Text="Nuevo" OnClick="btnNuevo_Click"
                            OnClientClick="return fn_Nuevo();" />
                    </td>
                </tr>
            </table>
        </div>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblCalendarioId" runat="server" Text="" Font-Bold="True" ForeColor="#006699"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                    ...
                    <hr />
                    <p>
                        <asp:Button ID="btnGrabar" class="EstiloGeneralBoton btn-guardar" runat="server" ValidationGroup="Valida"
    ...
    <script type="text/javascript">
        var no_pagina = "MantReservacionSalas.aspx";
        /*[INICIO] - Variables Grilla Bandeja*/
        var idGrilla_Bandeja = "#grvBandeja";
        var idPieGrilla_Bandeja = "#grvBandeja_Pie";
        var strCabecera_Bandeja = ['', 'ID Calendario', 'Titulo', 'Ubicación', 'Area', 'Fecha', 'Hora Inicio', 'Hora Fin', 'Usuario'];
