<%@ Page Async="true" Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MantBoletines.aspx.cs" Inherits="GNProject.Views.portal.Mantenimientos.MantBoletines" UnobtrusiveValidationMode="None"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="title">
        Mantenimiento de Boletines</div>
    <br />
    <div id="Tab1">
        <div>
            <table>
                ...
                <ContentTemplate>
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="lblBoletinId" runat="server" Text="" Font-Bold="True" ForeColor="#006699"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr style="display:none;">
                            <td>
                                Imagen a Mostrar <span style="color:Red;">(PNG)</span>:
                            </td>
                            <td>
                                <asp:Label ID="lblNomImgMostrar" runat="server" Text=""></asp:Label>
                                <asp:FileUpload Width="300px" ID="FileUpload2" runat="server" />                    
                                <asp:ImageButton ID="IbtnEliminarImgMostrar" runat="server" Width="15px" 
                                    Height="15px" ImageUrl="~/img/img_buttons/icono_cerrar.png" 
                                    onclick="IbtnEliminarImgMostrar_Click" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                                Archivo <span style="color:Red;">(PDF)</span>:
                            </td>
                            <td>
                                 <asp:Label ID="lblNomBoletin" runat="server" Text=""></asp:Label>
    ...
    <script type="text/javascript">
        var no_pagina = "MantBoletines.aspx";
        /*[INICIO] - Variables Grilla Bandeja*/
        var idGrilla_Bandeja = "#grvBandeja";
        var idPieGrilla_Bandeja = "#grvBandeja_Pie";
        var strCabecera_Bandeja = ['', 'ID Boletin', 'Titulo', '<%=GNProject.Acceso.App_code_portal.Parametros.I_Texto_CategoriaAuxiliar%>', 'Usuario', 'Fecha'];
        var ModelCol_Bandeja = [
                            { name: 'Accion', width: 50, align: 'center' },
                            { name: 'Boletin_Id', index: 'Boletin_Id', width: 60, align: 'center' },
