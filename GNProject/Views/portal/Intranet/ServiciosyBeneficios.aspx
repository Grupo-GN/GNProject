<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ServiciosyBeneficios.aspx.cs" Inherits="GNProject.Views.portal.Intranet.ServiciosyBeneficios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="title">
        <label id="lblTitle">Lista de Servicios y Beneficios</label></div>
    <br />
    <div id="Tab1">
        <div>
            <table>
    ...
    <script type="text/javascript">
        var no_pagina = "ServiciosyBeneficios.aspx";
        /*[INICIO] - Variables Grilla Bandeja*/
        var idGrilla_Bandeja = "#grvBandeja";
        var idPieGrilla_Bandeja = "#grvBandeja_Pie";
        var strCabecera_Bandeja = ['ID Beneficio', 'Titulo', 'Descripción', 'Documento', 'Fecha'];
        var ModelCol_Bandeja = [
                            { name: 'Beneficio_Id', index: 'Beneficio_Id', width: 60, align: 'center', hidden: true },
