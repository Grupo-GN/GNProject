<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Procedimientos.aspx.cs" Inherits="GNProject.Views.portal.Intranet.Procedimientos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="title">
        <label id="lblTitle">Lista de Procedimientos y Normativas</label></div>
    <br />
    <div id="Tab1">
        <div>
            <table>
    ...
    <script type="text/javascript">
        var no_pagina = "Procedimientos.aspx";
        /*[INICIO] - Variables Grilla Bandeja*/
        var idGrilla_Bandeja = "#grvBandeja";
        var idPieGrilla_Bandeja = "#grvBandeja_Pie";
        var strCabecera_Bandeja = ['ID Procedimiento', 'Titulo', 'Descripción', 'Documento', '<%=Parametros.I_Texto_CategoriaAuxiliar%>', 'Fecha'];
        var ModelCol_Bandeja = [
                            { name: 'Procedimiento_Id', index: 'Procedimiento_Id', width: 60, align: 'center', hidden: true },
