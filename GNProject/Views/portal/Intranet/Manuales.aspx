<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manuales.aspx.cs" Inherits="GNProject.Views.portal.Intranet.Manuales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="title">
        <label id="lblTitle">Lista de Manuales</label></div>
    <br />
    <div id="Tab1">
        <div>
            <table>
    ...
    <script type="text/javascript">
        var no_pagina = "Manuales.aspx";
        /*[INICIO] - Variables Grilla Bandeja*/
        var idGrilla_Bandeja = "#grvBandeja";
        var idPieGrilla_Bandeja = "#grvBandeja_Pie";
        var strCabecera_Bandeja = ['ID Doc.', 'Titulo', 'Descripción', 'Documento', '<%=Parametros.I_Texto_CategoriaAuxiliar%>', 'Fecha'];
        var ModelCol_Bandeja = [
                            { name: 'Documento_Id', index: 'Documento_Id', width: 60, align: 'center', hidden: true },
