<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmReporteVacacionesDet.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.ReportesyConsultas.FrmReporteVacacionesDet" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
        ...
        <fieldset style="background-color: #FFF;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input id="txtFechaProcesar" type="text" value="<%=DateTime.Now.ToShortDateString() %>" style="width:70px;" />
                    </td>
                </tr>
                <tr>
    ...
    <script language="javascript" type="text/javascript">
        ...
        $("#btnVerReporte").click(function () {
            ...
            var FechaProceso = $("#txtFechaProcesar").val()

            if (Personal_Ids == "") {
                alert("Debe seleccionar al menos un personal.");
            }
            else if (FechaProceso == "") {
                alert("Debe ingresar fecha proceso.");
            }
            else {
                var parametros = Planilla_Ids
                    ...
                    + ":" + Personal_Ids
                    + ":" + FechaProceso;
                //fc_OpenReport("REP_VACACIONES_DETALLADO", parametros, "1");
                //var params = { 'prm': parametros.toString() };
                var params = { 'prm': parametros.toString() };
                openWindowWithPostRequest("../Reportes/FrmPrint.aspx?Reporte_Id=REP_VACACIONES_DETALLADO", params, "1");
            }
        });
        ...
        function openWindowWithPostRequest(URL_OPEN, PARAMETER_JSON_POST, fl_horizontal) {
            var winName = 'MyWindow';
            var winURL = URL_OPEN;
            var width = (fl_horizontal == "1" ? "1050" : "750")
            var windowoption = 'resizable=yes,height=600,width=' + width + ',location=0,menubar=0,scrollbars=1';
            //var params = { 'param1': '1', 'param2': '2' };
            var params = PARAMETER_JSON_POST;
