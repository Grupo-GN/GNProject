<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmPrm_x_Afp.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Datos.FrmPrm_x_Afp" %>
...
<div>
    <asp:Panel ID="pnlFiltro" runat="server">
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="AFP" CssClass="miLabel"></asp:Label>
                    </td>
                <td>
                    <asp:DropDownList ID="cboAfp" runat="server" CssClass="ddl" Width="200px" 
                        AutoPostBack="True" onselectedindexchanged="cboAfp_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                <td>
...
<div style="overflow: auto; width: 100%;">
    <asp:GridView ID="grvLista" runat="server" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="no_Concepto" HeaderText="Descripci�n" ReadOnly="true">
                <ItemStyle Width="636px" />
            </asp:BoundField>
            <asp:TemplateField HeaderText="Valor">
                <ItemTemplate>
                    <asp:TextBox ID="txtValor" runat="server" Width="91px" 
                    Text='<%# Eval("Valor") %>' CssClass="txt_align_derecha">
                    </asp:TextBox>
                </ItemTemplate>
