<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmPrm_x_Compania.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Datos.FrmPrm_x_Compania" %>
...
<div>
    <asp:Panel ID="pnlFiltro" runat="server">
        <table>
            <tr>
                <td>
                   <asp:Label ID="Label2" runat="server" Text="Compañia" CssClass="miLabel"></asp:Label> 
                   </td>
                <td>
                    <asp:DropDownList ID="cboCompania" runat="server" CssClass="ddl" Width="200px" 
                        AutoPostBack="True" onselectedindexchanged="cboCompania_SelectedIndexChanged">
                    </asp:DropDownList>
                </td>
                <td>
...
<div style="overflow: auto; width: 100%;">
    <asp:GridView ID="grvLista" runat="server" 
        ...
        DataKeyNames="Periodo_Id, Concepto_Id" ForeColor="#333333" 
        GridLines="None"
        AllowPaging="True" 
