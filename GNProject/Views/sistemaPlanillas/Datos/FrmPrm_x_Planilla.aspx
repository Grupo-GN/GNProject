<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmPrm_x_Planilla.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Datos.FrmPrm_x_Planilla" %>
...
<div>
    <asp:Panel ID="pnlFiltro" runat="server">
        <table>
            <tr>
                <td>
                <asp:Label ID="Label2" runat="server" Text="Planilla" CssClass="miLabel"></asp:Label> 
                    </td>
                <td>
                    <asp:DropDownList ID="cboPlanilla" runat="server" CssClass="ddl" Width="200px" 
                        AutoPostBack="True" 
                        onselectedindexchanged="cboPlanilla_SelectedIndexChanged" 
                        onprerender="cboPlanilla_PreRender">
                    </asp:DropDownList>
                </td>
                <td>
