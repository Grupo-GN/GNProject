<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntTipo_Via.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntTipo_Via" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE TIPO DE VIA" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Tipo de Via" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvTipo_Via" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Tipo_Via_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvTipo_Via_RowCancelingEdit" 
        onrowcommand="grvTipo_Via_RowCommand"
        onrowdeleting="grvTipo_Via_RowDeleting" 
        onrowediting="grvTipo_Via_RowEditing" 
        onrowupdating="grvTipo_Via_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvTipo_Via_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tipo_Via_Id" HeaderText="TIPO_VIA_ID" ReadOnly="true">
