<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntProyecto.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntProyecto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE GERENCIA / PROYECTO" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Proyecto" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvProyecto" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Proyecto_Id, Estado_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvProyecto_RowCancelingEdit" 
        onrowcommand="grvProyecto_RowCommand"
        onrowdatabound="grvProyecto_RowDataBound" 
        onrowdeleting="grvProyecto_RowDeleting" 
        onrowediting="grvProyecto_RowEditing" 
        onrowupdating="grvProyecto_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvProyecto_PageIndexChanging">
     ...
     <asp:TemplateField>
            ...
            <asp:BoundField DataField="Proyecto_Id" HeaderText="PROYECTO_ID" ReadOnly="true">
