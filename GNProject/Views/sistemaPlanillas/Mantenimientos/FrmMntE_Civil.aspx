<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntE_Civil.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntE_Civil" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE ESTADO CIVIL" CssClass="miTitulo"></asp:Label>
...
<div>
    <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Estado Civil" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvE_Civil" runat="server" Width="100%" 
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="E_Civil_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvE_Civil_RowCancelingEdit" 
        onrowcommand="grvE_Civil_RowCommand"
        onrowdeleting="grvE_Civil_RowDeleting" 
        onrowediting="grvE_Civil_RowEditing" 
        onrowupdating="grvE_Civil_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvE_Civil_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="E_Civil_Id" HeaderText="E_CIVIL_ID" ReadOnly="true">
