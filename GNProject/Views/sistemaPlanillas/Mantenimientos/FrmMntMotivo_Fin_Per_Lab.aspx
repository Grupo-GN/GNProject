<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntMotivo_Fin_Per_Lab.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntMotivo_Fin_Per_Lab" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE EXTINCIÓN DE CONTRATO" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<div>
        <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nueva Extinción de Contrato" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvMotivo_Fin_Per_Lab" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Motivo_Fin_Per_Lab_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvMotivo_Fin_Per_Lab_RowCancelingEdit" 
        onrowcommand="grvMotivo_Fin_Per_Lab_RowCommand"
        onrowdeleting="grvMotivo_Fin_Per_Lab_RowDeleting" 
        onrowediting="grvMotivo_Fin_Per_Lab_RowEditing" 
        onrowupdating="grvMotivo_Fin_Per_Lab_RowUpdating" ShowFooter="true" 
        AllowPaging="true" 
        onpageindexchanging="grvMotivo_Fin_Per_Lab_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Motivo_Fin_Per_Lab_Id" HeaderText="MOTIVO_FIN_PER_LAB" ReadOnly="true">
...
<asp:UpdateProgress ID="UpdateProgress1" runat="server" 
    ...
    <ProgressTemplate>
        ...
        <center>                                            
            ...
            alt="Procesando" ImageUrl="~/Views/sistemaPlanillas/Views/sistemaPlanillas/css/ajax-loader.gif" /> 
            </div> 
        </center>
    </ProgressTemplate>
