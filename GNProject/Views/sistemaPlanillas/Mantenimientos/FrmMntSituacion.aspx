<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntSituacion.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntSituacion" %>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE SITUACIÓN" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nueva Situación" CssClass="miTituloOnTab"></asp:Label>
</legend>
...
<div style="width:100%;">
    <asp:GridView ID="grvSituacion" runat="server"  Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Situacion_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvSituacion_RowCancelingEdit" 
        onrowcommand="grvSituacion_RowCommand"
        onrowdeleting="grvSituacion_RowDeleting" 
        onrowediting="grvSituacion_RowEditing" 
        onrowupdating="grvSituacion_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvSituacion_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Situacion_Id" HeaderText="SITUACION_ID" ReadOnly="true">
