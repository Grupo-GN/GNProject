<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntAreas.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntAreas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE AREAS" CssClass="miTitulo"></asp:Label>
    <br />
...
<fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nueva Area" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvArea" runat="server"  Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Area_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvArea_RowCancelingEdit" 
        onrowcommand="grvArea_RowCommand"
        onrowdeleting="grvArea_RowDeleting" 
        onrowediting="grvArea_RowEditing" 
        onrowupdating="grvArea_RowUpdating" ShowFooter="true" AllowPaging="True" 
        onpageindexchanging="grvArea_PageIndexChanging">
