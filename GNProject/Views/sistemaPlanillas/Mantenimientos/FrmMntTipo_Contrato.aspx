<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntTipo_Contrato.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntTipo_Contrato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE TIPO DE CONTRATOS" CssClass="miTitulo"></asp:Label>
...
<div>
        <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Tipo de Contrato" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvTipo_Contrato" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Tipo_Contrato_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvTipo_Contrato_RowCancelingEdit" 
        onrowcommand="grvTipo_Contrato_RowCommand"
        onrowdeleting="grvTipo_Contrato_RowDeleting" 
        onrowediting="grvTipo_Contrato_RowEditing" 
        onrowupdating="grvTipo_Contrato_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvTipo_Contrato_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tipo_Contrato_Id" HeaderText="TIPO_CONTRATO_ID" ReadOnly="true">
