...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <fieldset style="width: 100%; background-color: White; margin-left:auto; margin-right:auto; /*border-right: solid 1px black;border-left: solid 1px black; border-bottom: solid 1px black;*/ min-height: 500px;overflow: auto; border-radius: 8px 8px 0px 0px;/* border-top: solid 1px black;*/">
                ...
                <table style="width:100%;border-collapse:collapse;">
                    ...
                    <tr>
                        <td style="width:50%;vertical-align:top;">
                            <asp:CheckBoxList ID="chklistFijos" runat="server" Width="100%" BorderWidth="1px" CssClass="lbox" BorderColor="#CCCCCC" RepeatLayout="Flow">
                                <asp:ListItem>1</asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
                        <td style="vertical-align:top;/*background-color:#CED8F6;*/padding-right: 10px;">
                        ...
                        <td style="width:50%;vertical-align:top;">
                            <asp:CheckBoxList ID="chklistVariable" runat="server" Width="100%" BorderWidth="1px" CssClass="lbox" BorderColor="#CCCCCC" RepeatLayout="Flow" >
                                <asp:ListItem>1</asp:ListItem>
                            </asp:CheckBoxList>
                        </td>
