<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntTipo_Trabajador.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntTipo_Trabajador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <table align="center" width="100%">
   ...
   <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE TIPO DE TRABAJADOR" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<div>
        <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Tipo de Trabajador" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvTipo_Trabajador" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Tipo_Trabajador_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvTipo_Trabajador_RowCancelingEdit" 
        onrowcommand="grvTipo_Trabajador_RowCommand"
        onrowdeleting="grvTipo_Trabajador_RowDeleting" 
        onrowediting="grvTipo_Trabajador_RowEditing" 
        onrowupdating="grvTipo_Trabajador_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvTipo_Trabajador_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tipo_Trabajador_Id" HeaderText="TIPO_TRABAJADOR_ID" ReadOnly="true">
