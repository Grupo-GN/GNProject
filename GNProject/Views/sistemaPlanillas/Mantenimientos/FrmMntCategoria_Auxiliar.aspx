<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntCategoria_Auxiliar.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntCategoria_Auxiliar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <link href="../Styles/nuevoEstiloPlanilla.css" rel="stylesheet" type="text/css" />
     ...
     <td>
        ...
        <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE ÁREA" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<div>
    <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nueva Área" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvCategoria_Auxiliar" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Categoria_Auxiliar_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvCategoria_Auxiliar_RowCancelingEdit" 
        onrowcommand="grvCategoria_Auxiliar_RowCommand"
        onrowdeleting="grvCategoria_Auxiliar_RowDeleting" 
        onrowediting="grvCategoria_Auxiliar_RowEditing" 
        onrowupdating="grvCategoria_Auxiliar_RowUpdating" ShowFooter="true" 
        AllowPaging="true" 
        onpageindexchanging="grvCategoria_Auxiliar_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Categoria_Auxiliar_Id" HeaderText="Área ID" ReadOnly="true">
