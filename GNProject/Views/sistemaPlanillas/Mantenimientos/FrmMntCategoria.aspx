<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master"  CodeBehind="FrmMntCategoria.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntCategoria" %>
...
<div>
    ...
    <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nueva Categoria" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvCategoria" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Categoria_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvCategoria_RowCancelingEdit" 
        onrowcommand="grvCategoria_RowCommand"
        onrowdeleting="grvCategoria_RowDeleting" 
        onrowediting="grvCategoria_RowEditing" 
        onrowupdating="grvCategoria_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvCategoria_PageIndexChanging">
        ...
        <Columns>
           <asp:TemplateField>
            ...
            <asp:BoundField DataField="Categoria_Id" HeaderText="CATEGORIA_ID" ReadOnly="true">
