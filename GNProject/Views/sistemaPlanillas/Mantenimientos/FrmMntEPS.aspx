<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntEPS.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntEPS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE EPS" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<div>
    <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo EPS" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
                ...
                <td>
                     <asp:Label ID="Label1" runat="server" Text="RUC : " CssClass="miLabel"></asp:Label></td>
                <td>
                    <asp:TextBox ID="txtRucNuevo" runat="server" Width="100px" CssClass="txt"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtRucNuevo" 
                        runat="server" ErrorMessage="*" Text="*" ValidationGroup="ValidaGraba"></asp:RequiredFieldValidator>
                </td>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvEPS" runat="server" 
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" Width="100%"
        DataKeyNames="EPS_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvEPS_RowCancelingEdit" 
        onrowcommand="grvEPS_RowCommand"
        onrowdeleting="grvEPS_RowDeleting" 
        onrowediting="grvEPS_RowEditing" 
        onrowupdating="grvEPS_RowUpdating" ShowFooter="true" AllowPaging="true" 
        onpageindexchanging="grvEPS_PageIndexChanging">
        ...
        <Columns>
           <asp:TemplateField>
            ...
            <asp:BoundField DataField="EPS_Id" HeaderText="EPS_ID" ReadOnly="true">
            ...
            <asp:TemplateField HeaderText="RUC">
                       <HeaderStyle ForeColor="#336699" Font-Size="X-Small" 
                                                                        Font-Bold="True" />
                <EditItemTemplate>
                    <asp:TextBox ID="txtRuc" runat="server" Width="100px" Text='<%# Eval("RUC") %>' CssClass="txt"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ControlToValidate="txtRuc" 
                        runat="server" ErrorMessage="*" Text="*" ValidationGroup="Valida"></asp:RequiredFieldValidator>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label ID="lblRuc" runat="server" Text='<%# Eval("RUC") %>'></asp:Label>
                </ItemTemplate>
                <FooterTemplate>
                    <asp:TextBox ID="txtRucNew" runat="server" Width="100px" CssClass="txt"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ControlToValidate="txtRucNew" 
                        runat="server" ErrorMessage="*" Text="*" ValidationGroup="ValidaNew"></asp:RequiredFieldValidator>
                </FooterTemplate>
