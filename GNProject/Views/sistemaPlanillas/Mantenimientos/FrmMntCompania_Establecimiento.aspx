<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntCompania_Establecimiento.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntCompania_Establecimiento" %>
...
<div style="overflow: auto; width: 610px; ">
    <table class="gridSmallCabecera">
        <tr>
            <th width="58px"></th>
            <th width="127px">Establecimiento_Id</th>
            <th width="307px">Denominación</th>
        </tr>
    </table>
</div>
        ...
        <div style="overflow: auto; width: 610px; height: 400px; border:solid 0px;">
            <asp:GridView ID="grvCompania_Establecimiento" runat="server" 
                ...
                DataKeyNames="Establecimiento_Id,Compania_Id,Tipo_Establecimiento_Id,Codigo_Establecimiento,Denominacion,CentroRiesgo,Tasa,Estado_Id"
                ForeColor="#333333" GridLines="None"
                onrowcommand="grvCompania_Establecimiento_RowCommand"
                onrowdeleting="grvCompania_Establecimiento_RowDeleting" AllowPaging="True"
                onpageindexchanging="grvCompania_Establecimiento_PageIndexChanging">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Establecimiento_Id" HeaderText="Establecimiento_Id" ReadOnly="True">
...
<div class="textoGeneral">
    ...
    <asp:Panel ID="pnlNuevo" runat="server" GroupingText="Datos del Establecimiento">

        <table>
            <tr>
                <td>
                    Establecimiento Id</td>
                <td>
                    <asp:Label ID="lblEstablecimiento_Id" runat="server" Width="50px" Height="18px" CssClass="lblCod"></asp:Label>
                </td>
                <td>
                    &nbsp;</td>
            </tr>
            <tr>
                <td>Compañia</td>
                <td>
                    <asp:DropDownList ID="cboCompania" runat="server" CssClass="ddl" Width="150px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>Tipo</td>
                <td>
                    <asp:DropDownList ID="cboTipo_Establecimiento" runat="server" CssClass="ddl" Width="150px">
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>Código</td>
                <td>
                    <asp:TextBox ID="txtCodigo_Establecimiento" runat="server" CssClass="txt" 
                        Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                        ControlToValidate="txtCodigo_Establecimiento" ErrorMessage="*" Text="*" 
            ...
            <tr>
                <td>
                    Denominación</td>
                <td>
                    <asp:TextBox ID="txtDenominacion" runat="server" CssClass="txt" 
                        Width="300px"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                        ControlToValidate="txtDenominacion" ErrorMessage="*" Text="*" 
                        ValidationGroup="ValidaGraba"></asp:RequiredFieldValidator>
                </td>
                <td>
                    &nbsp;</td>
            ...
            <tr>
                <td>
                    Estado</td>
                <td>
                    <asp:DropDownList ID="cboEstado" runat="server" CssClass="ddl" Width="150px">
                    </asp:DropDownList>
                </td>
                <td>
                    &nbsp;</td>
