...
{
    public partial class MaestroPersonalActivo : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static ArrayList Lista_Personal_Faltante_Periodo(string Periodo, string Personal)
        {
            return ControllerMaestroPersonalActivo.GetInstance().Lista_Personal_Faltante_Periodo(Periodo, Personal);
        }
        [WebMethod]
        public static int Agrega_Personal_al_Periodo(string Periodo, string Personal)
        {
            return ControllerMaestroPersonalActivo.GetInstance().Agrega_Personal_al_Periodo(Periodo, Personal);
        }
        [WebMethod]
        public static int Elimina_Personal_de_Periodo(string Periodo, string Personal)
        {
            return ControllerMaestroPersonalActivo.GetInstance().Elimina_Personal_de_Periodo(Periodo, Personal);
        }
