<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntTipo_Establecimiento.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntTipo_Establecimiento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <table align="center" width="100%">
  ...
  <asp:Label ID="Label9" runat="server" Text=" MANTENIMIENTO DE TIPOS DE ESTABLECIMIENTO" CssClass="miTitulo"></asp:Label>
    <
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Tipo Establecimiento" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
                ...
                <td>
                    <asp:Button ID="btnGrabar" runat="server" Text="Grabar" 
                        ValidationGroup="ValidaGraba" onclick="btnGrabar_Click" CssClass="submit EstiloGeneralBoton btn-nuevo"/>
                </td>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvTipo_Establecimiento" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Tipo_Establecimiento_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvTipo_Establecimiento_RowCancelingEdit" 
        onrowcommand="grvTipo_Establecimiento_RowCommand"
        onrowdeleting="grvTipo_Establecimiento_RowDeleting" 
        onrowediting="grvTipo_Establecimiento_RowEditing" 
        onrowupdating="grvTipo_Establecimiento_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvTipo_Establecimiento_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tipo_Establecimiento_Id" HeaderText="TIPO_ESTAB_ID" 
            ReadOnly="true">
