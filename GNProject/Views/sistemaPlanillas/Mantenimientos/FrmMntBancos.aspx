<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntBancos.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntBancos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE BANCOS" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<div>
    ...
    <fieldset>
    <legend>
        <asp:Label ID="Label2" runat="server" Text="Nuevo Banco" CssClass="miTituloOnTab"></asp:Label>
    </legend>
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="Descripción : " CssClass="miLabel"></asp:Label>
                    </td>
                <td>
...
<div style="overflow: auto; width: 100%; ">
    <table class="gridSmallCabecera">
        <tr>
            <th width="45px"></th>
            <th width="108px"><asp:Label ID="Label3" runat="server" Text="BANCO_ID" CssClass="tituloGrilla"></asp:Label></th>
            <th width="784px"><asp:Label ID="Label1" runat="server" Text="DESCRIPCION" CssClass="tituloGrilla"></asp:Label></th>
        </tr>
    </table>
</div>
<div style="overflow: auto; width: 100%; height: 350px; border:solid 0px;">
    <asp:GridView ID="grvBancos" runat="server"   Width="100%"
        ShowHeader="false" 
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Banco_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvBancos_RowCancelingEdit" 
        onrowcommand="grvBancos_RowCommand" 
        onrowdeleting="grvBancos_RowDeleting" 
        onrowediting="grvBancos_RowEditing" 
        onrowupdating="grvBancos_RowUpdating" ShowFooter="true" AllowPaging=true 
        onpageindexchanging="grvBancos_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Banco_Id" HeaderText="Banco_Id" ReadOnly="true">
                <ItemStyle Width="69px" HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:TemplateField HeaderText="Descripcion">
                <EditItemTemplate>
                    <asp:TextBox ID="txtDescripcion" runat="server" Width="750px" Text='<%# Eval("Descripcion") %>' CssClass="txt">
                    </asp:TextBox>
