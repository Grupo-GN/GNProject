<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntTipo_Cta_Bancaria.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntTipo_Cta_Bancaria" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE TIPO DE CUENTA BANCARIA" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Tipo de Cuenta Bancaria" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvTipo_Cta_Bancaria" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="TCB_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvTipo_Cta_Bancaria_RowCancelingEdit" 
        onrowcommand="grvTipo_Cta_Bancaria_RowCommand"
        onrowdeleting="grvTipo_Cta_Bancaria_RowDeleting" 
        onrowediting="grvTipo_Cta_Bancaria_RowEditing" 
        onrowupdating="grvTipo_Cta_Bancaria_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvTipo_Cta_Bancaria_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TCB_Id" HeaderText="TCB_ID" ReadOnly="true">
