<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntPersonal_Anexo2.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntPersonal_Anexo2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE PERSONAL ANEXO 2" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<div>
    <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Personal Anexo 2" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvPersonal_Anexo2" runat="server"  Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Personal_Anexo2_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvPersonal_Anexo2_RowCancelingEdit" 
        onrowcommand="grvPersonal_Anexo2_RowCommand"
        onrowdeleting="grvPersonal_Anexo2_RowDeleting" 
        onrowediting="grvPersonal_Anexo2_RowEditing" 
        onrowupdating="grvPersonal_Anexo2_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvPersonal_Anexo2_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Personal_Anexo2_Id" HeaderText="PERSONAL_ANEXO2_ID" ReadOnly="true">
