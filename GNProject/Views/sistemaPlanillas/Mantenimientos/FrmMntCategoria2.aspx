<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntCategoria2.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntCategoria2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE CATEGORIA 2" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nueva Categoria2" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvCategoria2" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Categoria2_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvCategoria2_RowCancelingEdit" 
        onrowcommand="grvCategoria2_RowCommand"
        onrowdeleting="grvCategoria2_RowDeleting" 
        onrowediting="grvCategoria2_RowEditing" 
        onrowupdating="grvCategoria2_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvCategoria2_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Categoria2_Id" HeaderText="CATEGORIA2_ID" ReadOnly="true">
