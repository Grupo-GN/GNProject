<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntTipo_Zona.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntTipo_Zona" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <table align="center" width="100%">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE TIPO DE ZONA" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Tipo de Zona" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvTipo_Zona" runat="server" 
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Tipo_Zona_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvTipo_Zona_RowCancelingEdit" 
        onrowcommand="grvTipo_Zona_RowCommand"
        onrowdeleting="grvTipo_Zona_RowDeleting" 
        onrowediting="grvTipo_Zona_RowEditing"  Width="100%"
        onrowupdating="grvTipo_Zona_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvTipo_Zona_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tipo_Zona_Id" HeaderText="TIPO_ZONA_ID" ReadOnly="true">
