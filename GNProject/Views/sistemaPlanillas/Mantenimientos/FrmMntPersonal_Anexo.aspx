<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntPersonal_Anexo.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntPersonal_Anexo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE PERSONAL ANEXO" CssClass="miTitulo"></asp:Label>
    <br />
    <br />
...
<div>
    <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Personal Anexo" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvPersonal_Anexo" runat="server" Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Personal_Anexo_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvPersonal_Anexo_RowCancelingEdit" 
        onrowcommand="grvPersonal_Anexo_RowCommand"
        onrowdeleting="grvPersonal_Anexo_RowDeleting" 
        onrowediting="grvPersonal_Anexo_RowEditing" 
        onrowupdating="grvPersonal_Anexo_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvPersonal_Anexo_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Personal_Anexo_Id" HeaderText="PERSONAL_ANEXO_ID" ReadOnly="true">
