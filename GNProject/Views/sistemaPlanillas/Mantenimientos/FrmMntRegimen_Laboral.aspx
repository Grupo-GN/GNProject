<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="FrmMntRegimen_Laboral.aspx.cs" Inherits="GNProject.Views.sistemaPlanillas.Mantenimientos.FrmMntRegimen_Laboral" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <asp:Label ID="Label9" runat="server" Text="MANTENIMIENTO DE REGIMEN LABORAL" CssClass="miTitulo"></asp:Label>
...
<div>
        <fieldset>
<legend>
  <asp:Label ID="Label2" runat="server" Text="Nuevo Regimen Laboral" CssClass="miTituloOnTab"></asp:Label>
</legend>
        <table>
            <tr>
                <td>
...
<div style="width:100%;">
    <asp:GridView ID="grvRegimen_Laboral" runat="server"  Width="100%"
        AutoGenerateColumns="False" CellPadding="2" CssClass="gridSmall" 
        DataKeyNames="Regimen_Laboral_Id" ForeColor="#333333" 
        GridLines="None" onrowcancelingedit="grvRegimen_Laboral_RowCancelingEdit" 
        onrowcommand="grvRegimen_Laboral_RowCommand"
        onrowdeleting="grvRegimen_Laboral_RowDeleting" 
        onrowediting="grvRegimen_Laboral_RowEditing" 
        onrowupdating="grvRegimen_Laboral_RowUpdating" ShowFooter="true" 
        AllowPaging="true" onpageindexchanging="grvRegimen_Laboral_PageIndexChanging">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Regimen_Laboral_Id" HeaderText="REGIMEN_LABORAL_ID" ReadOnly="true">
